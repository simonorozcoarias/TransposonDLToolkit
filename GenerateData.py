...
Original file is located at
    https://colab.research.google.com/drive/17Wn0REj-22pQRXbcGN23-XoKac3NIS5-
"""
...
# Funciones para generar los casos de estudio
...
def datos_entrenamiento(caso):
    ...
    if caso == 1:
        ...
        # Microsatélite generado aleatoriamente
        ...
        # Microsatelite repetido del origen hasta el inicio la secuencia
        microsatelite = ""
        while len(microsatelite) < start_pos:
            microsatelite += monomer

        microsatelite += random_sequence.seq
        # Microsatelite repetido del final de la secuencia hasta la posición 20.000
...
# Uso de la funcion para generar el archivo fasta
