#!/bin/bash
#SBATCH --job-name=automodel_te_eval
#SBATCH --output=logs/slurm_automodel_eval_%j.out
#SBATCH --error=logs/slurm_automodel_eval_%j.err
...
################################################################################
# AutoModel Token Classification Model Evaluation - SLURM Job Script
#
# This script evaluates a fine-tuned AutoModel model on the test set.
...
echo "==================================="
echo "AutoModel Evaluation Job Started"
echo "==================================="
...
MODEL_PATH="results/automodel_te_token_classification"
...
stdbuf -oL -eL python -u scripts/evaluate_model_automodel.py \
