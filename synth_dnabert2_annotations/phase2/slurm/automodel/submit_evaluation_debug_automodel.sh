#!/bin/bash
#SBATCH --job-name=automodel_eval_debug
#SBATCH --output=logs/slurm_automodel_eval_debug_%j.out
#SBATCH --error=logs/slurm_automodel_eval_debug_%j.err
...
################################################################################
# AutoModel DEBUG Evaluation Script
#
...
#                      Default: results/automodel_debug_single_species
...
#   sbatch submit_evaluation_debug.sh results/automodel_debug_4_species datasets_combined/4_species_seed42_20251208_143022
#
#   # Multi-species with per-species metrics:
#   sbatch submit_evaluation_debug.sh results/automodel_debug_4_species datasets_combined/4_species_seed42_20251208_143022 --by_species
#
...
MODEL_PATH="${1:-results/automodel_debug_single_species}"
...
python -u scripts/evaluate_model_automodel.py \
